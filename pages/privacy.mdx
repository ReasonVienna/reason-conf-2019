...
To tracks visitor interaction with the website we use Google Analytics. That said no we do not
transmit personal data to Google Analytics. IPs are anonmyized and cookie usage is deactivated
for Google Analytics. The data we gather is stored for 24 months.
...
The last update to our Privacy Statement was posted on January 6th, 2019.
