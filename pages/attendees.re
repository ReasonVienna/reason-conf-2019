...
[@bs.module] external tu1Path: string = "../assets/img/tu-1.jpg";

[@bs.module] external tu2Path: string = "../assets/img/tu-2.jpg";

/* let tarifezonesHref = Gatsby.Link.withPrefix({j|tarifzones.png|j}); */

/* TODO: I don't know yet how to render absolute links in Antwar (check back with Juho) */
/*       Just talked to Juho: We should probably introduce a Markdown component like this: */
/*                            https://github.com/GraphQLFinland/site/blob/master/components/Markdown.js */
let tarifezonesHref = {j|tarifzones.png|j};
